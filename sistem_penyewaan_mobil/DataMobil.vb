...
Public Class DataMobil
    ...
    'Fungsi Mengambil database untuk ditampilkan di datagriddview
    ...
    'Function untuk menambah data mobil ke database
    ...
    'Fungsi Get data mobil berdasarkan ID Database
    ...
    'Fungsi mengambil Jenis Mobil berdasarkan ID Database
    ...
    Public Function UpdateStatusMobilByPlatDatabase(ID As String,
                                                status_sewa As String)
