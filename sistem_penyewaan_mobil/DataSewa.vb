...
Public Class DataSewa
    ...
    'Fungsi tambah data sewa ke dataabse
    ...
    'Fungsi edit sewa berdasarkan ID
    ...
    'Fungsi melihat data sewa by id database
    ...
    'Fungsi mengambil data mobil berdasar id database
    ...
    'Fungsi mengambil data penyewa lihat berdasar kan id database
    ...
    'Fungsi update sewa by database
