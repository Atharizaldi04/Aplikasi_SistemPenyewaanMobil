Public Class EditMobil
    Public Sub New()
        ...
        'Mengambil data dari class Data MObil untuk ditampilkan di info mobil
    ...
    'Fungsi menampilkan database pada data grid view data jenis mobil
    ...
    'Menjalan kan Fungsi menampilkan database pada datagridview mobil
    Private Sub EditMobil_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        ReloadDataTableDatabase()
    End Sub


    'Mengambil value ID Jenis mobil dari Data grid view Jenis Mobil
