Public Class TambahSewa
    ...
    Public Sub New()
        ...
        DTTanggalPinjam.MinDate = DateTime.Now.AddDays(1)
    End Sub
    ...
    Private Sub DGMobil_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DGMobil.CellClick
        ...
        BiayaSewa = selectedRow.Cells(4).Value
    ...
    Private Sub DTTanggalPinjam_ValueChanged(sender As Object, e As EventArgs) Handles DTTanggalPinjam.ValueChanged
        DTRencana_kembali.MinDate = DTTanggalPinjam.Value.AddDays(1)
    End Sub
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        totalbiaya = TotalHari * BiayaSewa
